...
export default function injectShaderCode(targetMaterial: THREE.MeshStandardMaterial, textureLoader: TextureLoader, textureScaling = 15.0) {
    // set 2
    ...
    targetMaterial.onBeforeCompile = (shader) => {
        ...
        shader.fragmentShader = shader.fragmentShader.replace(
            ...
            dedent`
                ...
                vec3 mapMX= mixDepthBased(vec4(mapM1, 1.0-perlinValue), vec4(mapM2, perlinValue));
        ...
        shader.fragmentShader = shader.fragmentShader.replace(
            ...
            dedent`
                    ...
                    vec3 AoMX = mixDepthBased(vec4(AoM1, 1.0-perlinValue), vec4(AoM2, perlinValue));
